...
{
    [DisplayName( "Person Registrations List" )]
    [Category( "Event" )]
    [Description( "Lists all the registrations for the person." )]
    ...
    [BooleanField(
        "Display Instance Path",
        Description = "",
        Key = AttributeKey.DisplayInstancePath,
        IsRequired = false,
    ...
    [BooleanField(
        ...
        Description = "",
        Key = AttributeKey.DisplayRegisteredBy,
        IsRequired = false,
        DefaultBooleanValue = true,
        Order = 3 )]
    ...
    [BooleanField(
        ...
        Description = "",
        Key = AttributeKey.DisplayActiveStatus,
        IsRequired = false,
        DefaultBooleanValue = true,
        Order = 5 )]
    ...
    [CustomDropdownListField(
        ...
        description: "Select which registrations to show, based on active status. Select [All] to let the user filter by active status.",
    ...
    [CategoryField(
        ...
        description: "",
        allowMultiple: true,
        entityTypeName: "RegistrationTemplate",
        required: false,
        order: 7,
        key: AttributeKey.DefaultCategories )]

    #endregion

    public partial class PersonRegistrationsList : RockBlock, ISecondaryBlock, ICustomGridColumns
    {
        #region Keys
        ...
        private static class AttributeKey
        {
            ...
            /// <summary>
            /// The display instance path
            /// </summary>
            public const string DisplayInstancePath = "DisplayInstancePath";

            /// <summary>
            /// The display registered by
            /// </summary>
            public const string DisplayRegisteredBy = "DisplayRegisteredBy";
            ...
            /// <summary>
            /// The display active status
            /// </summary>
            public const string DisplayActiveStatus = "DisplayActiveStatus";

            /// <summary>
            /// The limit to active status
            /// </summary>
            ...
            /// </summary>
            public const string DefaultCategories = "DefaultCategories";
        }
