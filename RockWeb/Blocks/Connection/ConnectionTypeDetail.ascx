                ...
                <div id="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <Rock:RockCheckBox ID="cbEnableRequestSecurity" runat="server" SourceTypeName="Rock.Model.ConnectionType, Rock" PropertyName="EnableRequestSecurity" Label="Enable Request Security" Help="When enabled, the assigned connector will be given edit and view rights to the connection request." />
                        </div>
                    </div>
