    ...
    public partial class AddCheckInManagerApp : Rock.Migrations.RockMigration
    {
        ...
        public override void Up()
        {
            Sql( @"UPDATE 
                    ...
                    WHERE
	                    [Guid] IN ('F3062622-C6AD-48F3-ADD7-7F58E4BD4EF3','31F51DBB-AC84-4724-9219-B46FADAB9CB2')
                " );
            ...
            // Block Attribute Value for Roster ( Page: Roster, Site: Rock Check-in Manager )        
            ...
            // Block Attribute Value for Live Metrics ( Page: Live Metrics, Site: Rock Check-in Manager )    
            ...
            // Block Attribute Value for Page Menu (  Layout: Full Width, Site: Rock Check-in Manager )
            ...
            // Block Attribute Value for Select Check-In Area ( Page: Check-in Type, Site: Rock Check-in Manager )           
            ...
            RockMigrationHelper.DeletePageRoute( "A2B6EA1C-9E46-42C8-ABE4-0FD32D562B48" );

            // Block Attribute Value for Search ( Page: Search, Site: Rock Check-in Manager )          
        ...
        public override void Down()
        {
            ...
            Sql( @"UPDATE 
                    ...
                    SET [Theme] = 'Rock'
                    WHERE
                        [Guid] = 'A5FA7C3C-A238-4E0B-95DE-B540144321EC'
