...
namespace Rock.Model
{
    ...
    /// </summary>
    public partial class FollowingService : Service<Following>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FollowingService"/> class
        /// </summary>
        /// <param name="context">The context.</param>
        public FollowingService(RockContext context) : base(context)
        {
        }
    ...
    /// </summary>
    public static partial class FollowingExtensionMethods
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static Following Clone( this Following source, bool deepCopy )
        {
            if (deepCopy)
            {
                return source.Clone() as Following;
            }
            else
            {
        ...
        /// <param name="source">The source.</param>
        public static void CopyPropertiesFrom( this Following target, Following source )
        {
            target.Id = source.Id;
