...
namespace Rock.Model
{
    ...
    public static partial class NoteWatchExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this NoteWatch object to a new NoteWatch object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static NoteWatch CloneWithoutIdentity( this NoteWatch source )
        {
            var target = new NoteWatch();
            target.CopyPropertiesFrom( source );
