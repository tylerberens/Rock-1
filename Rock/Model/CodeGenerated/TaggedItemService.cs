...
namespace Rock.Model
{
    ...
    public static partial class TaggedItemExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this TaggedItem object to a new TaggedItem object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static TaggedItem CloneWithoutIdentity( this TaggedItem source )
        {
            var target = new TaggedItem();
            target.CopyPropertiesFrom( source );
