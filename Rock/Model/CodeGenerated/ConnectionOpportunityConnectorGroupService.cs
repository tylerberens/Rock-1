...
namespace Rock.Model
{
    ...
    public static partial class ConnectionOpportunityConnectorGroupExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this ConnectionOpportunityConnectorGroup object to a new ConnectionOpportunityConnectorGroup object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static ConnectionOpportunityConnectorGroup CloneWithoutIdentity( this ConnectionOpportunityConnectorGroup source )
        {
            var target = new ConnectionOpportunityConnectorGroup();
            target.CopyPropertiesFrom( source );
