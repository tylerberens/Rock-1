...
namespace Rock.Model
{
    ...
    public static partial class FinancialScheduledTransactionDetailExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this FinancialScheduledTransactionDetail object to a new FinancialScheduledTransactionDetail object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static FinancialScheduledTransactionDetail CloneWithoutIdentity( this FinancialScheduledTransactionDetail source )
        {
            var target = new FinancialScheduledTransactionDetail();
            target.CopyPropertiesFrom( source );
