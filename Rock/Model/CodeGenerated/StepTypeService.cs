...
namespace Rock.Model
{
    ...
    public static partial class StepTypeExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this StepType object to a new StepType object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static StepType CloneWithoutIdentity( this StepType source )
        {
            var target = new StepType();
            target.CopyPropertiesFrom( source );
