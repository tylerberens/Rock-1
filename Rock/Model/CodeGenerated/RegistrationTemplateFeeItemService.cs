...
namespace Rock.Model
{
    ...
    public static partial class RegistrationTemplateFeeItemExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this RegistrationTemplateFeeItem object to a new RegistrationTemplateFeeItem object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static RegistrationTemplateFeeItem CloneWithoutIdentity( this RegistrationTemplateFeeItem source )
        {
            var target = new RegistrationTemplateFeeItem();
            target.CopyPropertiesFrom( source );
