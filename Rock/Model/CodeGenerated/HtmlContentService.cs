...
namespace Rock.Model
{
    ...
    public static partial class HtmlContentExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this HtmlContent object to a new HtmlContent object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static HtmlContent CloneWithoutIdentity( this HtmlContent source )
        {
            var target = new HtmlContent();
            target.CopyPropertiesFrom( source );
