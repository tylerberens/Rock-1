...
namespace Rock.Model
{
    ...
    public static partial class StepWorkflowTriggerExtensionMethods
    {
        ...
        /// <summary>
        /// Clones this StepWorkflowTrigger object to a new StepWorkflowTrigger object with default values for the properties in the Entity and Model base classes.
        /// </summary>
        /// <param name="source">The source.</param>
        /// <returns></returns>
        public static StepWorkflowTrigger CloneWithoutIdentity( this StepWorkflowTrigger source )
        {
            var target = new StepWorkflowTrigger();
            target.CopyPropertiesFrom( source );
