...
{
    /// <summary>
    /// Allows an SMS sender to make a payment.
    /// </summary>
    /// <seealso cref="SmsActionComponent" />
    ...
    [TextField(
        ...
        defaultValue: "GIVE",
        order: 1,
        category: AttributeCategories.Giving,
    ...
    [TextField(
        ...
        defaultValue: "REFUND",
        order: 6,
        category: AttributeCategories.Refund,
    ...
    public class SmsActionGive : SmsActionComponent
    {
        ...
        private SmsMessage DoRefund( SmsActionCache action, SmsMessage message, out string errorMessage )
        {
            ...
            var smsGiftSourceId = DefinedValueCache.GetId( SystemGuid.DefinedValue.FINANCIAL_SOURCE_TYPE_SMS_GIVE.AsGuid() );
