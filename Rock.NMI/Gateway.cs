...
namespace Rock.NMI
{
    ...
    public class Gateway : ThreeStepGatewayComponent
    {
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException">paymentInfo</exception>
        public override bool UpdateScheduledPaymentStep3( FinancialScheduledTransaction transaction, PaymentInfo paymentInfo, string resultQueryString, out string errorMessage )
        {
            errorMessage = string.Empty;
            ...
            try
            {
                ...
                // Check to see if third step is not needed or succesfully completed
                if ( !CompleteThirdStep( transaction.FinancialGateway, paymentInfo, resultQueryString, out errorMessage ) )
                {
                    return false;
                }
                ...
                GetScheduledPaymentStatus( transaction, out errorMessage );
