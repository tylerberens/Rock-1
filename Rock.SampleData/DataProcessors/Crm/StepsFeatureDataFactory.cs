...
namespace Rock.SampleData.Crm.Steps
{
    ...
    /// </summary>
    public class StepsFeatureDataFactory : SampleDataFactoryBase
    {
        ...
        private Step CreateWellKnownStep( Guid stepGuid, Guid stepTypeGuid, int personAliasId, Guid stepStatusGuid, DateTime? completedDateTime )
        {
            var newStep = new Step();
        ...
        public override List<SampleDataChangeAction> GetActionList()
        {
            ...
            AddNewChangeAction( actions, "Add Standard Sample Data", "Add the standard sample data set for the Steps feature." );
            AddNewChangeAction( actions, "Add Randomized Step Participations", "Add a large randomized set of Step Participations suitable for load testing.", "Add Bulk" );
            AddNewChangeAction( actions, "Remove Standard Sample Data", "Remove the standard sample data set for the Steps feature.", "Delete" );
        ...
        {
            actions.Add( new SampleDataChangeAction { Category = "CRM > Steps", Key = name, Name = name, Description = description, Action = action } );
        }
        ...
        protected override SampleDataChangeActionExecutionResponse OnExecuteAction( string actionId, ISampleDataChangeActionSettings settings, ITaskMonitorHandle monitor )
        {
            ...
            {
                AddStepsFeatureTestData();
            }
            else if ( actionId == "Add Randomized Step Participations" )
            {
                AddStepsRandomParticipationEntries();
            }
